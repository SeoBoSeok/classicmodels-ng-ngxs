...
import { CustomerShowComponent } from '../../../modules/customer/components/customerShow.component';
...
describe('create CustomerShowComponent', () => {

    let comp: CustomerShowComponent;
    ...
    it('should instantiate CustomerShowComponent', () => {
