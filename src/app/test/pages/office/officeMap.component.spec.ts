...
import { OfficeMapComponent } from '../../../modules/office/components/officeMap.component';
...
describe('create OfficeMapComponent', () => {

    let comp: OfficeMapComponent;
    ...
    it('should instantiate OfficeMapComponent', () => {
